...
.hero-section {
	background: url('image/station.jpeg') no-repeat center;
...
<body>
	...
	<section class="hero-section">
		<h1 style="color: white;">Train Ticket Booking</h1>
					...
					<form method="post" action="flightSearch">
						...
						<div class="row mt-2">
							...
							<div class="col-md-6 d-flex" style="margin-top: 40px;">
								<span style="position: absolute; top: 40%; font-weight: bold;">Tatkal
									Open</span>
		...
		<div class="container" id="offers">
			...
			<div class="row mt-3">
				<div class="col-md-4 pt-3" id="offer">
					<img
						src="https://promos.makemytrip.com/images//Desktop-Trains-Dussehra-25Jun.jpg?im=Resize=(134,134)"
					...
					<p style="font-size: 14px; font-weight: 500;">
						&emsp;Book by paying 25% of the <label
							style="margin-left: 15px; font-size: 14px; font-weight: 500;">fare*
							with our Seat Lock</label> <label
							style="margin-left: 15px; font-size: 14px; font-weight: 500;">feature.
						</label>
					</p>
					<a href="#"
						style="float: right; margin-top: -2%; text-decoration: none; font-weight: bold;">Book
						Now</a>
				</div>
				<div class="col-md-4 pt-3" style="margin-left: 15px;" id="offer">
					<img
						src="https://promos.makemytrip.com/appfest/xhdpi//Desktop-VandeBharat-4May.jpg?im=Resize=(134,134)"
						id="offimage"> <span id="text">Book Tickets for Vande
						<label>&emsp;Bharat Express</label>
					</span>
					<hr style="margin-left: 43%; color: red; margin-right: 35%;">
					<p style="font-size: 14px; font-weight: 500;">&emsp;With us
						hassle-free & get set &emsp;for a train journey</p>
					<a href="#"
				...
				<div class="col-md-4 pt-3" style="margin-left: 15px;" id="offer">
					<img
						...
						id="offimage"> <span id="text">Trip Gurantee on
						Trains! </span>
					<hr style="margin-left: 43%; color: red; margin-right: 35%;">
					<span style="font-size: 14px; font-weight: 500;">&emsp;Get a confirmed ticket or a<label>&emsp;free upgrade to flights,cabs &</label>&emsp;more.</span>
					<a href="#"
